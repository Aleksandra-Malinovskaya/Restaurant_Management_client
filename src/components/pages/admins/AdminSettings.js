...
const AdminSettings = () => {
  ...
  // ИСПРАВЛЕНО: возврат на панель администратора
  const handleBack = () => {
                  ...
                  <div className="col-md-6">
                    <div className="d-flex align-items-center">
                      <button
                        ...
                        onClick={handleBack}
                        title="Вернуться на панель администратора" // ИСПРАВЛЕНО: текст подсказки
                      >
                      ...
                      <div>
                        <h1 className="h3 mb-2">
                          ...
                          Настройки администратора {/* ИСПРАВЛЕНО: заголовок */}
                        </h1>
                        <p className="text-muted mb-0">
                          Управление настройками аккаунта администратора{" "}
                          {/* ИСПРАВЛЕНО: описание */}
                        </p>
                      </div>
                    </div>
